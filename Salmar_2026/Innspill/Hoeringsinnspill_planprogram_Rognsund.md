# Innspill til planprogram – Detaljregulering for akvakultur i Rognsund

**Krav om fullstendig kartlegging, utredning og dokumentasjon av alle relevante forhold**
...
## 1. Innledning og formål med innspillet

Undertegnede viser til varsel om oppstart av detaljregulering med konsekvensutredning for akvakultur i Rognsund, og avgir med dette innspill til **planprogrammet** innen fristen 01.07.2026.
...
- **Lakselusmodellering** for vill laksefisk i hele influensområdet, og smoltens utvandringsruter gjennom Rognsund (én av tre hovedruter, sammen med Stjernsundet og Vargsundet).
- Konsekvenser for **sjøørret og sjørøye**, som er like følsomme for lakselus som laks, men ofte underkommunisert.
- **Rømming og genetisk innkryssing** i ville bestander, vurdert opp mot klimaframskrivninger med hyppigere ekstremvær.
...
- **Egglarvedrift** (lodde, sild, torsk, hyse, sei, uer) og **særlig verdifulle områder (SVO)** for fisk i og rundt Rognsund.
- Konsekvenser for **dyreplankton** og produksjonsgrunnlaget i næringskjeden.
...
- Påvirkning på **hval og sjøpattedyr**. Altafjord-/Rognsundsystemet er registrert som beite- og hårfellingsområde for flere hvalarter (bl.a. **knølhval** og **vågehval**), og Altafjorden er et internasjonalt kjent hvalområde (spekkhogger, knølhval, finnhval). I tillegg er mer stedbundne arter som **kvitnos** og **nise** til stede i Rognsund hele året. **Havert** og **ringsel** (begge rødlistet VU) er registrert i området.
- **Undervannsstøy** fra anlegg (fôrflåter, fortøyninger, båttrafikk) og virkning på sjøpattedyrenes kommunikasjon, beiting og atferd – utredet med sertifisert akustisk fagkompetanse.
- **Kollisjonsrisiko** mellom båttrafikk til/fra anlegg og sjøpattedyr.

### 3.8 Tradisjonelt fiske og kystflåtens fiskefelt
- Konsekvenser for **tradisjonelt fiske** og kystflåtens tilgang til mye brukte fiskefelt i Rognsund (aktive og passive redskaper), herunder registrerte **fiskeplasser** og **låssettingsplasser** (Fiskeridirektoratets kystnære fiskeridata).
- Arealbeslag og fortrengning av fiske, og at **Fiskeridirektoratet** gis reell anledning til å uttale seg.

### 3.9 Sjøsamiske interesser og reindrift
- **Sjøsamisk fiske og kultur** utredet som eget deltema – hele Rognsund ligger i et sjøsamisk område med bosetting i lange tider.
- **Reindrift** i berørte distrikter **24A Oarje-Sievju** og **25 Stierdná**, herunder støypåvirkning.
- At **konsultasjon etter sameloven § 4-4** gjennomføres, og at Sametingets planveileder (ut til 1 nautisk mil) legges til grunn.

### 3.10 Verneområder og landskap
- Visuell påvirkning på **Seiland nasjonalpark** (alpint landskap, IUCN II, tilstøtende), dokumentert med **3D-modell og visualiseringer** fra ulike vinkler, slik kommunen har bedt om.
- Indirekte virkninger på **Lopphavet marine verneområde**.
- Landskapsvirkning og påvirkning på opplevelseskvaliteter, siktlinjer og kystlandskapet.

### 3.11 Forholdet til overordnet plan (FFNFA / KPA)
- Avklaring av forholdet til **kommuneplanens arealdel (KPA) § 6.2.2**, som fastslår at oppdrett av anadrome fiskearter ikke er tillatt i FFNFA-områder. Den sørlige lokaliteten ligger i et slikt område, og planinitiativet er merket «**strider med overordnet/gjeldende plan**».
- At motstriden med overordnet plan utredes og avklares juridisk før planarbeidet føres videre.

### 3.12 Farled, sikkerhet og hvit lyktesektor
- **Hvit lyktesektor** fra Mjånes fyr og forholdet til faste installasjoner, med endelig vurdering fra **Kystverket**.
- Sikkerhet for **farled og ferdsel** (rutegående trafikk, yrkes- og fritidsbåter, kajakk).

### 3.13 Skred, flodbølge og samfunnssikkerhet
...
- **Lys- og lydforurensning** fra anlegg og hensynssoner for dette, herunder virkning på nattehimmel og naturopplevelse.
- **Folkehelse** og bomiljø, herunder trygghet og trivsel.

### 3.16 Klima, ekstremvær og beredskap
- **Rømningsrisiko** og driftssikkerhet vurdert opp mot **klimaframskrivninger** (økt frekvens av ekstremvær, marine hetebølger).
- **Beredskap** ved akutt forurensning, rømming og masseutslipp, og håndtering av dødfisk/ensilasje.

### 3.17 Kulturminner i sjø og marinarkeologi
- **Marinarkeologisk** kartlegging av kulturminner i sjø (i dag ukjent/lavt kunnskapsnivå), i samråd med de tre involverte myndighetene (Finnmark fylkeskommune, Sametinget, UiT Norges arktiske universitetsmuseum).

### 3.18 Fiskehelse, sykdom, legemidler og dyrevelferd
- **Smitte- og sykdomsrisiko** (bl.a. PD, ILA) og spredning til vill fisk og mellom anlegg.
- Bruk og spredning av **legemidler og avlusningsmidler**, og virkning på ikke-målarter (reker, skjell, andre krepsdyr).
- **Fiskevelferd** og dødelighet, jf. dyrevelferdsloven.

### 3.19 Forholdet til nasjonalt regelverk i endring
- At plan og konsekvensutredning **tar høyde for retningen i nasjonal havbrukspolitikk** (Meld. St. 24 (2024–2025) «Fremtidens havbruk» med Stortingets behandling), herunder miljøbetingelser, lusekvoter, tapsavgift og miljøteknologiordninger – slik at planen ikke baseres på utdaterte forutsetninger.

### 3.20 Svakheter i planinitiativets § 10-vurdering
- At forhåndskonklusjoner (f.eks. om at nasjonalparken «ikke påvirkes negativt») og selvmotsigelser (f.eks. at vannkvalitetsmål «ikke er overskredet» samtidig som kjemisk tilstand er ukjent) **rettes opp** og at § 10-vurderingen oppdateres før planprogrammet fastsettes.
...
## 5. Krav om prosess, medvirkning og innsyn

- At **folkemøter** i bygdene avholdes på en måte som gir reell medvirkning, og at berørte parter og lag/foreninger inviteres.
- At **konsultasjon etter sameloven kap. 4** gjennomføres for samiske og sjøsamiske interesser.
- At det gis **innsyn etter offentleglova § 25** i alle relevante saksdokumenter, herunder korrespondanse og innrapporterte miljøundersøkelser, slik at allmennheten kan følge prosessen.
- At berørte **sektormyndigheter** (Statsforvalteren, Sametinget, Kystverket, Fiskeridirektoratet, NVE, Mattilsynet, Finnmark fylkeskommune) gis reell anledning til å vurdere saken, herunder eventuell innsigelse.
...
## Vedlegg og kunnskapsgrunnlag

Dette innspillet bygger på offentlig tilgjengelig planmateriale og åpne fagkilder, blant annet:

- Planinitiativ, oppstartsmøtereferat og planprogram (Rambøll/SalMar, 2025–2026).
- Kommuneplanens arealdel for Alta 2021–2040 (§ 6.2.2 m.fl.).
- Havforskningsinstituttet: Risikorapport norsk fiskeoppdrett 2025.
- Artsdatabanken / Artskart: områdeuttrekk av rødlistede arter for Rognsund (476 funn, 61 taksa; eksport 17.06.2026).
- Fiskeridirektoratets kartportal (kystnære fiskeridata, gyteområder, fiskeplasser, akvakulturregister).
- Vann-Nett (vannforekomster i Rognsund), naturmangfoldloven, vannforskriften, sameloven, plan- og bygningsloven.
- En utvidet faglig sammenstilling med kart og kilder finnes i prosjektets `PLAN-SAMMENSTILLING.md`.

> Avsender står fritt til å forkorte, utdype eller velge ut de temaene man selv er mest opptatt av. Alle innspill teller med i den samlede vurderingen.
