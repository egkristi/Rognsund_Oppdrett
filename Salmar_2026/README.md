...
| # | Fil | Beskrivelse |
|---|-----|-------------|
| 1 | `D-bre-001 Varsel om oppstart Rognsund.md` | Formelt varsel om oppstart |
| 2 | `Kunngjøring_ Rognsund akvakultur - Ramboll - [www.ramboll.com].md` | Rambølls kunngjøring |
| 3 | `Varsel om oppstart av detaljregulering for akvakultur i Rognsund - [www.alta.kommune.no].md` | Alta kommunes kunngjøring |
| 4 | `Vedlegg 1 - Planinitiativ.md` | Planinitiativ (OCR) – 13 sider |
...
|-------|------------------|
| **Statsforvalteren i Troms og Finnmark** | Fremme **innsigelse** – stopper planen |
| **Sametinget** | Kreve konsultasjon – kan løftes til departementet |
| **Kystverket** | Avvise plassering pga. hvit lyktesektor |
| **Fiskeridirektoratet** | Innsigelse på gyteområder og fiskeinteresser |
| **NVE** | Innsigelse på skredfare |
| **Mattilsynet** | Fiskehelse og lakselus |
| **Naturvernforbundet / WWF / FNF** | Innsigelse og/eller søksmål |
| **Bygdelag** (Hakkstabben, Altnes, Kvalfjord) | Lokal mobilisering |
| **Reinbeitedistrikter** (24A, 25) | Samiske rettigheter |
| **Lokale medier** (Altaposten, iFinnmark) | Offentlig debatt |
...
|----------|----------------------|
| **Villaks** | Altaelva = nasjonal lakseelv. 16 % vandrer gjennom Rognsundet. Allerede moderat tilstand. |
| **FFNFA-forbud** | KPA §6.2.2: Oppdrett av anadrome fiskearter er ikke tillatt i FFNFA. |
| **Kunnskapsmangel** | Kjemisk tilstand, fugl, kulturminner, strømdata – alt mangler. Føre-var-prinsippet gjelder. |
| **Vannforskriften** | God økologisk status i dag – nytt oppdrett kan true måloppnåelse. |
| **Nasjonalpark** | Seiland nasjonalpark – synlige anlegg svekker verneverdien. |
| **Truede arter** | Krykkje, lunde, storskarv, torsk – flere rødlistede arter. |
| **Samiske rettigheter** | Konsultasjonsplikt. Kan forsinke eller stanse prosessen. |
| **Hvit lyktesektor** | Mjånes fyr – kan være absolutt hinder for plassering. |
| **Skredfare** | Snøskred kan utløse flodbølger. Registrert skred i 2010. |
| **«Samme biomasse»** | Ingen juridisk garanti. Reguleringsplanen åpner bare for etablering. |
